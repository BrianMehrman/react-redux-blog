            ...
            <div className="col-xs-2 col-md-1 col-lg-1">
              <div className="row">
                <div className="col-md-12">
                  <Link className="btn btn-primary" to={`/preview/${post.id}`} onClick={() => this.selectPost(post) }>Preview</Link>
                </div>
              </div>
              <div className="row">
                <div className="col-md-12">
                  <Link className="btn btn-primary" to={`/post/${post.id}`} onClick={() => this.selectPost(post) }>View Post</Link>
                </div>
              </div>
            </div>
